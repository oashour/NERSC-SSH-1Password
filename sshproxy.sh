...
# Minor modifications by Omar A. Ashour (UC Berkeley Physics/LBNL Molecular Foundry)
# Edits just add an option to pass a password and username automatically, normally generated by 1Password
...
while getopts "aphvs:k:U:u:o:x:c:w:" opt; do
	case ${opt} in
...
if [ ! -z ${onepass} ]; then
    ...
    echo "SSH Proxy: manual password entry required."
